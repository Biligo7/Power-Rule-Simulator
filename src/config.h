...
namespace cfg {
    ...
    constexpr float accent_blue_r = 76.0f, accent_blue_g = 161.0f, accent_blue_b = 200.0f;
    constexpr float accent_fire_r = 220.0f, accent_fire_g = 20.0f, accent_fire_b = 60.0f;
    ...
    constexpr float tree_burning_r = accent_fire_r;
    constexpr float tree_burning_g = accent_fire_g;
    constexpr float tree_burning_b = accent_fire_b;
    // Sliders defaults
